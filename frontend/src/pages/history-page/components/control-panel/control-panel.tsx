...
const ControlPanelContainer: React.FC<ControlPanelProps> = ({ className }) => {
	const { accounts } = useSelector(selectAccounts);
	const { categories } = useSelector(selectCategories);
	const dispatch = useDispatch();

	const { isFilter, parametrs } = useSelector(selectFilter) as FilterState;
